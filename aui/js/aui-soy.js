...
aui.dropdown2.trigger = function(opt_data, opt_sb) {
  ...
  param7.append(' aui-dropdown2-trigger');
...
aui.inlineDialog2.trigger = function(opt_data, opt_sb) {
  ...
  aui.renderExtraAttributes(opt_data, param31);
  param31.append(' data-aui-trigger ');
  aui.trigger.trigger(soy.$$augmentMap(opt_data, {showIcon: opt_data.showIcon ? opt_data.showIcon : false, extraAttributes: param31.toString()}), output);
  return opt_sb ? '' : output.toString();
};
if (goog.DEBUG) {
