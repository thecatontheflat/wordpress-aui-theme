...
(function ($) {
    ...
    Sidebar.prototype.reflow = function (scrollTop, viewportHeight, viewportWidth) {
    ...
    return skate('aui-select', {
        ...
        events: {
            ...
            'keydown input': function (element, e) {
                ...
                } else if ((e.keyCode === AJS.keyCode.UP || e.keyCode === AJS.keyCode.DOWN) && hasResults(element)) {
                    focusInHandler(element);
                    e.preventDefault();
                }
